...
public class CustomActionBarDrawerToggle implements DrawerLayout.DrawerListener {
    private static final String LOG_TAG = "CustomActionBarDrawerT";
    ...
    public static class CustomDrawerIndicatorToggle extends CustomDrawerIndicator implements DrawerToggle {
    ...
    private static class JellybeanMr2Delegate implements Delegate {
        private static final String LOG_TAG = "JellybeanMr2Delegate";
    ...
    static class ToolbarCompatDelegate implements Delegate {
        private static final String LOG_TAG = "ToolbarCompatDelegate";
