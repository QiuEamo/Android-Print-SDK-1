...
public class PostcardJob extends Job {
    ...
    public PostcardJob(long jobId, Product product, int orderQuantity, HashMap<String, String> optionsMap, Object frontImage, Object
            backImage, String message, Address address, int shippingClass) {
    ...
    public PostcardJob(Product product, int orderQuantity, HashMap<String, String> optionsMap, Object frontImage, Object backImage,
    ...
    public boolean equals(Object otherObject) {
        ...
        if (otherObject == null || (!(otherObject instanceof PostcardJob))) {
            return false;
        }
        ...
        if (!UploadableImage.areBothNullOrEqual(mBackUploadableImage, otherPostcardJob.mBackUploadableImage)) {
            return false;
        }

        if (!StringUtils.areBothNullOrEqual(mMessage, otherMessage)) {
            return false;
        }

        if (!Address.areBothNullOrEqual(mAddress, otherAddress)) {
            return false;
        }
