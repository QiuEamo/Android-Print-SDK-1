...
public class GreetingCardJob extends Job {
    ...
    public GreetingCardJob(Product product, int orderQuantity, HashMap<String, String> optionsMap, Object frontImage, Object backImage,
    ...
    List<UploadableImage> getImagesForUploading() {
        ...
        if (mBackUploadableImage != null) {
            uploadableImageArrayList.add(mBackUploadableImage);
        }
        if (mInsideLeftUploadableImage != null) {
            uploadableImageArrayList.add(mInsideLeftUploadableImage);
        }
        if (mInsideRightUploadableImage != null) {
            uploadableImageArrayList.add(mInsideRightUploadableImage);
        }
    ...
    JSONObject getJSONRepresentation() {
        ...
        try {
            ...
            if (mInsideRightUploadableImage != null) {
                assets.put("inside_right_image", mInsideRightUploadableImage.getUploadedAssetId());
            }
            if (mInsideLeftUploadableImage != null) {
                assets.put("inside_left_image", mInsideLeftUploadableImage.getUploadedAssetId());
            }
    ...
    public boolean equals(Object otherObject) {
        ...
        if (otherObject == null || (!(otherObject instanceof GreetingCardJob))) {
            return false;
        }
        ...
        if (!UploadableImage.areBothNullOrEqual(mBackUploadableImage, otherGreetingCardJob.mBackUploadableImage)) {
            return false;
        }
        if (!UploadableImage.areBothNullOrEqual(mInsideLeftUploadableImage, otherGreetingCardJob.mInsideLeftUploadableImage)) {
            return false;
        }
        if (!UploadableImage.areBothNullOrEqual(mInsideRightUploadableImage, otherGreetingCardJob.mInsideRightUploadableImage)) {
            return false;
        }
